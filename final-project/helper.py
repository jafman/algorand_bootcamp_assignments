...
user_mnemonic = "border risk lucky boil drill memory avocado aware ceiling outside machine steel foster bulk lend voice coin spread few stage taxi rain model able section"
...
def sendDonation(client, private_key, receiver, amount):
    # declare sender
    sender = account.address_from_private_key(private_key)
...
def main():
    ...
    fundingEnd = status["last-round"] + 100

    # create list of bytes for app args
    app_args = [
        intToBytes(fundingEnd),
    ]
    ...
    call_app(algod_client, creator_private_key, app_id, [b"donate", b"10"])
    ...
    print("Total amount raised so far:", amount_raised)
